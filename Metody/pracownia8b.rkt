...
;MOJ KOD:xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
(define (lazy-let? t)
  (and (tagged-tuple? 'lazy-let 3 t)
       (let-def? (cadr t))))
#|robiłem sposobem pierwszym tj. w lazy-let dodaję do środowiska domknięcie i potem
 w rozpatrywaniu środowiska sprawdzam czy coś jest domknięciem, jeśli tak to wywołuję je zamiast podstawiać
 pomoc z pomysłem od: Dominik Hawryluk|#
