...
;ZADANIE: EWALUATOR W EWALUATORZE
...
;TESTY: wyrażenia przedstawiam w postaci listy, złożonej z cons, jak w kodzie z wykładu
;żeby przetestować trzeba zamienić wyrażenie pod count
#|2+1: (cons (quote +)
            (cons 2 1))|#
#|(1+1)+(1+1): (cons (quote +)
                 (cons (cons (quote +)
